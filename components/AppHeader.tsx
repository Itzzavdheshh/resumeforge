  ...
  return (
    <header className="flex h-14 w-full items-center justify-between border-b border-zinc-800/80 bg-zinc-950 px-4 text-white shrink-0 select-none">
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        {/* Standalone GitHub Connection Button */}
        {onOpenGitHubModal && (
          <button
            onClick={onOpenGitHubModal}
            className={`flex items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs transition-colors focus:outline-none focus:ring-1 focus:ring-zinc-500 ${
            ...
            title={
              githubStatus?.connected && githubStatus.user
                ? `GitHub connected as @${githubStatus.user.login}`
                : "Manage GitHub account connection"
            }
          >
